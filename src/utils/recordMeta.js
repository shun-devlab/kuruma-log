export const RECORD_TYPES = [
  ...
  { value: 'oil_filter', label: 'オイルフィルター', fullLabel: 'オイルフィルター', icon: '🧩' },
  { value: 'ac_filter', label: 'エアコンフィルター', fullLabel: 'エアコンフィルター', icon: '🌬️' },
  { value: 'wiper_rubber', label: 'ワイパーゴム', fullLabel: 'ワイパーゴム', icon: '🌧️' },
